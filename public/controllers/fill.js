(function() {
    ...
    angular
        .module('app')
        .controller('FillController', ['$scope', 'QuestionnaireService', '$mdDialog', function($scope, QuestionnaireService, $mdDialog) {
            ...
            $scope.save = function(questionnaire) {
                ...
                newQuestionnaire.$save()
                    .then(
                        function(data) {
                            showToast('K�simustik edukalt salvestatud: ' + questionnaire.title);
